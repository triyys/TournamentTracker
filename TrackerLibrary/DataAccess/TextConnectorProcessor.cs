...
namespace TrackerLibrary.DataAccess.TextHelpers // vi de phan biet voi SqlConnector
{
    public static class TextConnectorProcessor
    {
        ...
        public static void SaveRoundsToFile(this TournamentModel model)
        {
            ...
            foreach (List<MatchupModel> round in model.Rounds)
            {
                foreach (MatchupModel matchup in round)
                {
                    ...
                    matchup.SaveMatchToFile(GlobalConfig.MatchupFile, GlobalConfig.MatchupEntryFile);
                }
            }
        }
        ...
        public static void SaveMatchToFile(this MatchupModel matchup, string matchupFile, string matchupEntryFile)
        {
